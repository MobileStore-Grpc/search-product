...
var (
	filter_SearchService_SearchMobile_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_SearchService_SearchMobile_0(ctx context.Context, marshaler runtime.Marshaler, client SearchServiceClient, req *http.Request, pathParams map[string]string) (SearchService_SearchMobileClient, runtime.ServerMetadata, error) {
	var protoReq SearchMobileRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_SearchService_SearchMobile_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	stream, err := client.SearchMobile(ctx, &protoReq)
	if err != nil {
...
func RegisterSearchServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SearchServiceServer) error {
	...
	mux.Handle("GET", pattern_SearchService_SearchMobile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterSearchServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SearchServiceClient) error {
	...
	mux.Handle("GET", pattern_SearchService_SearchMobile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/pb.SearchService/SearchMobile")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SearchService_SearchMobile_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_SearchService_SearchMobile_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_SearchService_SearchMobile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "mobile", "search"}, ""))
)

var (
	forward_SearchService_SearchMobile_0 = runtime.ForwardResponseStream
)
